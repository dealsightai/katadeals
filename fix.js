...
fs.writeFileSync('src/components/PdfExportButton.tsx', [
'"use client";',
...
// Add PDF button to the deal result page
var idPage = fs.readFileSync('src/app/analyze/[id]/page.tsx', 'utf8');
if (idPage.indexOf('PdfExportButton') === -1) {
  ...
  fs.writeFileSync('src/app/analyze/[id]/page.tsx', idPage);
  console.log('Added PDF button to deal page');
}
