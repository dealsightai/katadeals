...
fs.mkdirSync('src/app/construction', { recursive: true });

fs.writeFileSync('src/components/ConstructionCalculator.tsx', [
'"use client";',
...
fs.writeFileSync('src/app/construction/page.tsx', [
